...
## 1.随机试验
**试验(Experiment)** 是一个含义广泛的术语，其包括科学实验，也包括对事物的观察。  
我们先举一些试验的例子：  
...
## 2.样本空间、随机事件
### (一)样本空间
随机试验E的**所有可能结果**组成的集合，称为E的**样本空间(Sample Space)**，记为S；  
样本空间中的元素，称为**样本点**。
...
$S_5:\{0,1,2,3,...\}$  
$S_6:\{t|t≥0\}$  
$S_7:\{(x,y)|T_0≤x≤y≤T_1\}$ 这里x表示最低温度(以℃计)，y表示最高温度(以℃计)。并设这一地区的温度不会小于 $T_0$，也不会大于 $T_1$.  
